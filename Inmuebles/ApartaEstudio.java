...
public class ApartaEstudio extends Apartamento {
    ...
    static protected double  valorArea = 1500000;
    /**
    ...
    * @param dirección Parámetro que define la dirección donde ses
    ...
    */
    public ApartaEstudio(int identificadorInmobiliario, int area, String direccion, int númeroHabitaciones, int númeroBaños) {
