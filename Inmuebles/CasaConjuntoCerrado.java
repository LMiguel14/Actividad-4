...
public class CasaConjuntoCerrado extends CasaUrbana {
    ...
    */
    public CasaConjuntoCerrado(int identificadorInmobiliario, int area, String direccion, int númeroHabitaciones, 
        int númeroBaños,int númeroPisos, int valorAdministracion, boolean tienePiscina,boolean tieneCamposDeportivos) {
        // Invoca al constructor de la clase padre
        super(identificadorInmobiliario, area, direccion, númeroHabitaciones, númeroBaños, númeroPisos);
